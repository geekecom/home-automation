...
if ($function == 'switchLight') {
    switchLight($input);
    echo "switchLight".$input;
} else if ($function == 'setAllLights') {
    setAllLights($input);
}else{
    echo "Función no reconocida: ".$function;
}
...
//Conmuta el estado de todas las luces
